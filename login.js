...
function write_login() {
  ...
  <div class = 'password_div'>
      ...
      <i class="fa fa-eye-slash" id="togglePassword3" onclick="vis('lg_pass', 'lgp', 'togglePassword3')" style="margin-left: -32px; cursor: pointer;"></i>
  </div>
  </form>
...
<div class = 'password_div'>
  ...
  <i class="fa fa-eye-slash" id="togglePassword1" onclick="vis('cr_pass', 'crp', 'togglePassword1')" style="margin-left: -32px; cursor: pointer;"></i> 
</div>
<div class = 'password_div'>
  <input type="password" id = "cr_confirm" class = 'loginInput' autofocus placeholder="confirm password">
  <i class="fa fa-eye-slash" id="togglePassword2" onclick="vis('cr_confirm', 'crc', 'togglePassword2')" style="margin-left: -32px; cursor: pointer;"></i>
</div>
</form>
<div class = 'button_div'>
...
<div class = 'password_div'>
  ...
  <i class="fa fa-eye-slash" id="fgEye1" onclick="vis('fg_pass', 'fgp', 'fgEye1')" style="margin-left: -32px; cursor: pointer;"></i> 
</div>
<div class = 'password_div'>
  <input type="password" id = "fg_conf" class = 'loginInput' autofocus placeholder="confirm password">
  <i class="fa fa-eye-slash" id="fgEye2" onclick="vis('fg_conf', 'fgc', 'fgEye2')" style="margin-left: -32px; cursor: pointer;"></i>
</div>
</form>
<div class = 'button_div'>
